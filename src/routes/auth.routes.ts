...
router.get(
  ...
  passport.authenticate("google", {
    failureRedirect: "http://redibo-back-wtt.vercel.app:3000?error=google",
    session: true,
  }),
  (req, res) => {
    // 🔥 Redirige al front para que abra el modal de completar perfil
    res.redirect("http://redibo-back-wtt.vercel.app:3000/home?googleComplete=true");
  }
);
...
router.get(
  "/auth/google/callback",
  passport.authenticate("google", {
    failureRedirect: "http://redibo-back-wtt.vercel.app:3000/home?error=cuentaExistente",
    session: true,
  }),
  (req, res) => {
    res.redirect("http://redibo-back-wtt.vercel.app:3000/home?googleComplete=true");
